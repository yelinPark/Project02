//
//  RegisterDataPMTableViewController.swift
//  project02
//
...
class RegisterDataPMTableViewController: UITableViewController {
    ...
    @IBAction func buttonLogout(_ sender: UIBarButtonItem) {
        ...
        alert.addAction(UIAlertAction(title: "Yes", style: .default, handler: { action in let urlString: String = "http://condi.swu.ac.kr/student/T05/login/insertUser.php"
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        let fetchRequest = NSFetchRequest<NSManagedObject>(entityName: "EnrollmentTablePM")
        do {
    ...
    */
    ...
    override func prepare (for segue: UIStoryboardSegue, sender: Any?) { // Get the new view controller using segue.destinationViewController. // Pass the selected object to the new view controller.
        if segue.identifier == "ToDetailPMView" {
            if let destination = segue.destination as? DetailPMViewController {
